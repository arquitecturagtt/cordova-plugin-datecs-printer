...
public class DatecsSDKWrapper {
    ...
    private final ProtocolAdapter.ChannelListener mChannelListener = new ProtocolAdapter.ChannelListener() {
        ...
        public void onOverHeated(boolean state) {
            if (state) {
                //showToast("La impresora esta sobrecalentada");
            }
        }
        ...
        public void onLowBattery(boolean state) {
            if (state) {
                showToast("Poca bateria en la impresora");
            }
        }
    };
    ...
    private Map<Integer, String> errorCode = new HashMap<Integer, String>(){{
        ...
        put(2, "Ningún dispositivo Bluetooth encontrado");
        put(3, "A quantidade de linhas deve estar entre 0 e 255");
        put(4, "Error de papel en la impresora");
        put(5, "Error al imprimir");
        put(6, "Error ao buscar status");
        put(7, "Error ao buscar temperatura");
        put(8, "Error al imprimir código de barras");
        put(9, "Error al imprimir página de teste");
        put(10, "Error al setar configurações do código de barras");
        put(11, "Error al imprimir la multa");
    }};
        ...
        runJob(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    //showError("Fallo al conectar con la impresora: " + e.getMessage(), false);
                ...
                try {
                    ...
                    e.printStackTrace();
                    sendStatusUpdate(false);
                    showError("Fallo al inicializar: " + e.getMessage(), false);
                    return;
                }
            }
        }, "Conectando con impresora", "Espere por favor..");
    }
    ...
    public void printTaggedText(String text, String charset) {
        try {
          ...
          mPrinter.setPageRegion(0, 0, 590, 200, Printer.PAGE_LEFT);
          mPrinter.setPageXY(0, 5);
          mPrinter.printTaggedText("{reset}{center}{b}AYUNTAMIENTO{br}");
          mPrinter.drawPageFrame(0, 0, 590, 50, Printer.FILL_BLACK, 1);
          //mPrinter.drawPageRectangle(0, 0, 160, 32, Printer.FILL_INVERTED);
          mPrinter.setPageXY(0, 70);
          ...
          mPrinter.drawPageFrame(0, 0, 590, 200, Printer.FILL_BLACK, 1);
    ...
    public void printImage(String image, int width, int height, int align) {
        try {
            ...
            bitmap.recycle();
            mPrinter.reset();
            mPrinter.printCompressedImage(argb, imgWidth, imgHeight, Printer.ALIGN_CENTER, true);
            mPrinter.flush();
            mCallbackContext.success();
        } catch (Exception e) {
            //showToast(e.toString());
